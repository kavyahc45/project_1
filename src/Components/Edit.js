...
class Edit extends Component {
  ...
  handleSubmit(event) {
    ...
    axios.put('http://localhost:4013/users/studentProfile/update/' + this.props.match.params.id, profileuser)
  ...
  componentDidMount() {
    ...
    debugger;
    axios.get('http://localhost:4013/users/edit/' + this.props.match.params.id)
